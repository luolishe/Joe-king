...
var logoPath = logo.querySelectorAll('path');
...
function _animateStripes(container) {
    ...
    var _loop = function _loop(i) {
        ...
        var lineOptions = {x: point.x, y: point.y, width: width, height: height, color: color};
        ...
        dynamics.setTimeout(function () {
            ...
            dynamics.setTimeout(function () {
                ...
                var newLineOptions = options.transform({width: lineOptions.width, height: lineOptions.height});
...
function animateBlackStripes(container) {
    ...
    options.transform = function (size) {
        return {width: size.width / 2, height: size.height / 5};
    };
...
function cloneAndStripeElement(element, clipPathName, parent) {
    ...
    box = {top: box.top - parentBox.top, left: box.left - parentBox.left, width: box.width, height: box.height};
    ...
    for (var j = 0; j < els.length; j++) {
        ...
        for (var i = 0; i < masks.length; i++) {
            ...
            for (var k = 0; k < childrenEls.length; k++) {
                ...
                dynamics.css(childrenEls[k], {color: rgb, fill: rgb});
            }
        }
...
function showContent() {
    ...
    var _loop2 = function _loop2(i) {
        ...
        var transform = {translateX: Math.round(Math.random() * 40 - 20)};
        var more = el.getAttribute('data-idx') <= 3;
        dynamics.css(el, transform);
        dynamics.setTimeout(function () {
            dynamics.css(el, {display: ''});
        }, d);
        maxDelay = Math.max(maxDelay, d);
        dynamics.setTimeout(function () {
            dynamics.css(el, {translateX: Math.round(transform.translateX / -5)});
        }, d + 100);
        dynamics.setTimeout(function () {
            dynamics.css(el, {translateX: 0, translateY: 0});
            if (!more) {
        ...
        if (more) {
            dynamics.setTimeout(function () {
                dynamics.css(el, {translateX: Math.round(transform.translateX / -2)});
            }, d + 300);
            dynamics.setTimeout(function () {
                el.parentNode.removeChild(el);
            }, d + 550);
...
(function () {
    animateBlackStripes(stripesEl, {count: 200});
    animateColoredStripes(stripesEl, {count: 100});
    dynamics.css(pageEl, {scale: 0.95});
    dynamics.animate(pageEl, {scale: 1}, {type: dynamics.easeInOut, friction: 500, duration: 4000});
    dynamics.css(logo, {scale: 1});
    dynamics.animate(logo, {scale: 0.90}, {duration: 1500, type: dynamics.easeOut});
    var color = tinycolor('hsl(' + Math.round(Math.random() * 360) + ', 80%, 65%)');
    dynamics.animate(logoPath, {fill: color.toRgbString()}, {duration: 700});
    color = tinycolor('hsl(' + Math.round(Math.random() * 360) + ', 80%, 65%)');
    dynamics.animate(logoPath, {fill: color.toRgbString()}, {duration: 700, delay: 700});

    function animateLogo() {
        dynamics.css(logoContainer, {scale: 0.5, translateX: Math.random() * 100 - 50});
        dynamics.setTimeout(function () {
            dynamics.css(logoContainer, {translateX: 10, scale: 0.55});
        }, 100);
        dynamics.setTimeout(function () {
            dynamics.css(logoContainer, {translateX: 0, scale: 0.5});
        }, 150);
    };animateLogo();
    dynamics.setTimeout(function () {
    ...
    dynamics.setTimeout(function () {
        animateLogo();
        animateBlackStripes(stripesEl, {count: 200, delayShow: true});
        animateColoredStripes(stripesEl, {count: 100});
    }, 1000);
    dynamics.setTimeout(function () {
    ...
    dynamics.setTimeout(function () {
        dynamics.css(logoContainer, {scale: 0.75});
    }, 1350);
    dynamics.setTimeout(function () {
...
(function () {
    ...
    function animateCrazyLogo() {
        ...
        for (var i = 0; i < masks.length; i++) {
            ...
            dynamics.css(path, {fill: _color2.toRgbString()});
        ...
        var _loop3 = function _loop3(_i3) {
            ...
            dynamics.setTimeout(function () {
                ...
                dynamics.css(clonedEl, {translateX: Math.random() * 100 - 50});
            }, d);
            dynamics.setTimeout(function () {
                dynamics.css(clonedEl, {translateX: Math.random() * 20 - 10});
            }, d + 50);
            dynamics.setTimeout(function () {
                dynamics.css(clonedEl, {translateX: Math.random() * 5 - 2.5});
            }, d + 100);
            dynamics.setTimeout(function () {
    ...
    function animateLink(el) {
        ...
        var animate = function animate() {
            ...
            var _loop4 = function _loop4(_i4) {
                ...
                dynamics.css(clonedEl, {translateX: Math.random() * 10 - 5});
                dynamics.setTimeout(function () {
                    dynamics.css(clonedEl, {translateX: 0});
                }, 50);
                dynamics.setTimeout(function () {
                    dynamics.css(clonedEl, {translateX: Math.random() * 5 - 2.5});
                }, 100);
